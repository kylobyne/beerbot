...
ADMIN_PANEL = "Админ-панель для создания, удаления и перенастройки промокодов"
...
PROMO_FINAL = "Вы создаете промокод - {name}\n\nПроверьте настройки перед сохранением"
...
PROMO_EDIT_TITLE = "Вы настраиваете промокод - {name}\n\nВыберите параметр для изменения"
...
PROMO_NOT_VALID = "Промокод больше не действителен"
PROMO_USER_ONLY = "Этот промокод доступен только другому пользователю"
...
PROMO_USAGE = "Используйте: /promo ПРОМОКОД"